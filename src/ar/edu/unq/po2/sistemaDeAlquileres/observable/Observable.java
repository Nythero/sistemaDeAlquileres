...
public class Observable {
	 ...
	 * @throws Exception 
	 */
	public int getCantidadDeSuscritosAUnaSuscripcion(String suscripcion) throws Exception {
		this.verificarSubscripcion(suscripcion);
	...
	public void remove(String tipoDeSuscripcion,IObserver observer) throws Exception {
		this.verificarSubscripcion(tipoDeSuscripcion);
		if(!estaSuscrito(tipoDeSuscripcion,observer)) {
			throw new Exception("No se encuentra suscrito el usuario dado");
		}
		else {
	...
	private void verificarSubscripcion(String tipoDeSubscripcion) throws Exception {
		if(!this.existeLaSuscripcion(tipoDeSubscripcion)) {
			throw new Exception("No existe la suscripcion buscada");
		}
	}
